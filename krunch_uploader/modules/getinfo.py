...
def get_files(authenticate, cloud_url):
    ...
    container_list = os.listdir(absolute_path)
    dir_list =  [os.path.abspath(os.path.join(absolute_path, x)) for x in os.listdir(absolute_path)]
	...
	for root, dirs, files in os.walk(directory, topdown=False):
		...
		foo = (file_name, real_filename, dir_name, authenticate.token, cloud_url)
		file_list.append(foo)

    #remove duplicate container names(directory names)
    print "done!"
